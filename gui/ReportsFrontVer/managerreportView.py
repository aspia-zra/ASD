...
from models.ReportsBEver.managerReportModel import ReportModel
...
class ReportsView(ctk.CTkFrame):
    ...
    def _load_occupancy(self):
        ...
        rows = self.rc.get_occupancy_report(city)
        self._fill_tree(
            self.occ_tree,
    ...
    def _load_financial(self):
        data, summary = self.rc.get_financial_report()
    ...
    def _load_maintenance(self):
        data, summary = self.rc.get_maintenance_report()
